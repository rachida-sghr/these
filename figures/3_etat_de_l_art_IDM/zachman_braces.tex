...
\setlength{\mylastcolwidth}{\dimexpr0.06\mytablewidth-2\tabcolsep\relax}
...
\begin{adjustbox}{width=\mytablewidth,center}
    ...
    \begin{tikzpicture}[overlay,remember picture]
        ...
        \def\zachmancolwidth{2.12}  % ~ column width (found manually)
        \def\zachmanleftoffset{2.95}  % ~ first column offset (found manually)
