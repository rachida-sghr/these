...
\textit{ExcuteEA}. 
% La construction de ce cadre d'architecture et sa mise à 
% l'épreuve ont fait l'objet d'une recherche explicative en adoptant une démarche déductive. 
% expliquer ce que c'est une approche déductive
...
Dans ces travaux de thèse, une attention singulière est apportée à la délimitation de l'objet d'étude. 
