...
\begin{adjustbox}{width=\bigtable,center}
    ...
    \begin{tabulary}{\bigtable}{@{}>{\bfseries}p{\myfirstcolumn}p{\mycolumnwidth}p{\mycolumnwidth}p{\mycolumnwidth}@{}}
        ...
        %  --------------------------------------------------------------------
        \multirow{1}{\myfirstcolumn}{Motto} \
        ...
        & Enterprise architecture is the means for organisational innovation and sustainability \
        \tabularnewline\midrule
        %  --------------------------------------------------------------------
        \multirow{3}{\myfirstcolumn}{Objectives and concerns} \
        ...
        \tabularnewline\midrule
        %  --------------------------------------------------------------------
        \multirow{4}{\myfirstcolumn}[4pt]{Principles and assumptions} \
        & Apply a reductionist (machnistic) stance \
