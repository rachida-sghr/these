...
français. Un fichier XML spécifiant l'éditeur, l'année d'édition et la langue de carte
joue le rôle de modèle de cette carte dans une base de donnée. 
Dans ce contre-exemple, le fichier XMLn'est pas un métamodèle de la France. Un métamodèle 
...
\begin{table}[!ht]
    \vspace*{0.5em}
    \makebox[\linewidth][l]{%
      \hspace{3mm}\input{figures/3_etat_de_l_art_IDM/zachman_braces}%
    }
