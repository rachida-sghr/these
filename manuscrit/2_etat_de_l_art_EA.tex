...
La méthode ADM correspond un processus de conception cyclique. Elle préconise
...
La méthode ADM commence par une phase préliminaire qui consiste à initialiser
...
huit phases, notée de A à G, relatives à la création des vues métier,
applicative, information et technique. Il s'agit ensuite de planifier le
déploiement de l'architecture avant de l'implémenter. La dernière phase
...
\begin{figure}[!ht]
    \begin{center}
        \input{figures/dimensions_lankhorst}
    \end{center}
...
concepts de l'ordre organisationnels tels que les concepts d'entité, de rôle
qu'elle joue, des services qu'elle procure et des processus dans lesquels elle
...
sur deux métamodèles différents~:~un premier métamodèle correspondant au
