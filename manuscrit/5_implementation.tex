...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[angle=90, width=1\textwidth]{figures/images/implementation/architecture_generale_usecase.pdf}
 \end{center}
...
\lstinputlisting{figures/code/tournee.ocl}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[trim= 0cm 16cm 0cm 0cm, width=1\textwidth]{figures/images/implementation/integration_affection_gestion.pdf}
 \end{center}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[width=1\textwidth]{figures/images/implementation/simu_capture_ecran.png}
 \end{center}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[width=1\textwidth]{figures/images/implementation/resultat_simu.png}
 \end{center}
...
\lstinputlisting{figures/code/affectations.mzn}
