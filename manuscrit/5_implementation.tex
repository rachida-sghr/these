...
Papyrus offre la possibilité d'étendre la sémantique d'exécution de fUML à travers les \emph{Opaque Action}\footnote{}. Celles-ci permettent d'invoquer des modules d'applications extérieures au moment de l'exécution du diagramme d'activité fUML. Un stagiaire a développé cette extension en collaboration avec l'équipe Triskel. L'extension permet d'invoquer directement le module MiniZinc pour optimiser l'affectation des véhicules aux tournées.
