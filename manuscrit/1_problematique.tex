...
\textbf{Partie 1~: \q{État de l'art}}
    ...
    \begin{description}
        ...
        \q{Architecture d'Entreprise}

        \item[Le chapitre 3] 

        \q{Ingénieurie Dirigée par les Modèles}
...
\textbf{Partie 2~: \q{Une approche unificatrice par les modèles}}
    ...
    \begin{description}
        ...
        \item[Le chapitre 4] \q{lExecuteEA}

        \item[Le chapitre 5] \q{Implémentation et validation}

        \item[Le chapitre 6] \q{Délimitation de l'objet de recherche}

    \end{description}

\textbf{Partie 2~: \q{Conclusion et perspectives}}

    \begin{description}

        \item[Le chapitre 7] \q{Résumé des contribution et perspectives}
