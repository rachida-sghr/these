...
\gls{si} 
des gestionnaires du réseau électrique. En effet, ces \gls{si} doivent 
pleinement 
...
partenaires, en passant par ses objectifs, ses clients et ses processus métier. Par exemple, 
...
une vision globale et transverse \cite{zachman1987framework}. Dans le contexte des 
...
transmission des objectifs stratégiques à tous les niveaux hiérarchiques de l'organisation en 
question \cite{kappelman2008enterprise}. 

Pour toutes ces raisons, nous souhaitons mettre à profit les principes 
d'\gls{ea} pour évaluer l'impact de l'adoption des technologies Smart Grids sur les \gls{si} des 
...
correspondent par conséquence à des systèmes dynamiques aux comportements complexes. Borshchev et 
...
aspects statiques et structurels tels que les interconnexions entre les différentes 
applications métier \cite{buckl2008towards}. De plus, les modèles issus de ces 
