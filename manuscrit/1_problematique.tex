...
Outre leurs \gls{si}, les gestionnaires de réseaux électriques doivent faire évoluer 
...
au cœur de l'\gls{ea}\footnote{L'acronyme EA (\textit{Enterprise Architecture}) est souvent utilisé même dans la communauté francophone.} \cite{zachman1997enterprise}, nous
...
et des objectifs différents. Les \gls{si} pilotant les  Smart Grids correspondent par 
conséquence à des systèmes dynamiques aux comportements complexes. Borshchev et 
...
Néanmoins, les approches d'\gls{ea} se focalisent le plus souvent sur des aspects 
statiques et structurels tels que les interconnexions entre les différentes 
