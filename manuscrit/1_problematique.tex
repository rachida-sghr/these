...
Un Smart Grid est un réseau électrique qui répond aux exigences suivantes~:
    \begin{itemize}
        ...
        \item fourniture électricité de qualité face aux besoins du 21\up{ème}
              siècle~;
...
À partir de ces deux définitions, nous constatons que les impératifs régulatoires et 
...
Dès lors, pour des raisons environnementales législatives mais aussi financières, ces pics doivent être écrêtés.
...
d'\q{effacement} aux consommateurs moyennant des incitations tarifaires. L'effacement peut
...
\textbf{Partie 1~: \q{État de l'art}}

    \begin{description}

        \item[Le chapitre 2~:  \q{Architecture d'Entreprise}]  Ce chapitre présente les notions fondamentales de l'EA 
...
considérons donc dans ce les approches d'analyses existantes.

        \item[Le chapitre 3~: \q{Ingénieurie Dirigée par les Modèles}] Ce chapitre présente les objectifs, les concepts fondamentaux et les techniques principales de l'IDM. Nous considérons
ensuite les approches d'EA existantes qui recourent à l'IDM et nous en dressons les contributions et les limites. 

    \end{description}

\textbf{Partie 2~: \q{Une approche unificatrice par les modèles}}

    \begin{description}

        \item[Le chapitre 4~: \q{lExecuteEA}] Dans ce chapitre, nous examinons tout d'abord les pratiques actuellles d'EA
...
destinons à l'analyse de la structure et du comportement d'une architecture d'entreprise. 
        ...
        \item[Le chapitre 5 : \q{Implémentation et validation}] Ce chapitre décrit l'implémentation qui concrétise
...
flotte de véhicules électriques.
        ...
        \item[Le chapitre 6 : \q{Délimitation de l'objet de recherche}] Dans ce chapitre, nous abordons la question de la délimitation de l'objet d'étude.
...
\textbf{Partie 3~: \q{Conclusion et perspectives}}

    \begin{description}

        \item[Le chapitre 7 : \q{Résumé des contribution et perspectives}] Ce chapitre résume les contributions de cette thèse et dresse les perspectives qui lui sont associées.
