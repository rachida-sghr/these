...
distribution présentant une forte pénétration de {\color{red}{DER}}. C'est le cas d'application
...
d'utilisation plus que d'autres {\color{red}{(les équipes n'aime pas les nouvelles méthodes /
cadres de travail ref frameworks)}}. De plus, cet exercice ayant été mené par des
équipes dont le profil est fortement technique, les vues composant et communication du
...
régulation de tension sur un réseau électrique n'a pas été suffisante {\color{red}{à
...
Le contexte de cette thèse {\color{red}{CIFRE}} a favorisé les échanges avec les experts et les
...
de régulation sont écrits en {\color{red}{C++}}.
...
d'une flotte de véhicules électriques. Ce projet est en effet transverse {\color{red}{à
l'ensemble de l'entreprise et ==> puisqu'il}} touche plusieurs processus métier de
...
{\color{red}{Cependant}}, la recharge des véhicules électriques relève encore une fois du
domaine purement électrotechnique. {\color{red}{tu repetes ce que tu as dit 2 phrases avant}}Le cas métier de la gestion d'une flotte de
...
en passant même par le responsable des tournées. De plus, {\color{red}{même s'il s'agit d'un
...
sont pour l'essentiel textuels. Cependant, des \textit{slides} {\color{red}{annexes}} de présentation
...
«~\textit{processus}~».{\color{red}{??}} Ainsi nous retrouvons~:
...
Cet aspect décrit les modules logiciels qui {\color{red}{implantent}} les blocs
...
synchronisation de données, transfert de fichiers périodique. {\color{red}{etc.?}}
...
l'ensemble de l'entreprise {\color{red}{dont la stratégie}}. L'aspect objectif est un moyen de
modéliser explicitement la stratégie de l'entreprise, traduite en un ensemble
cohérent d'objectifs métier {\color{red}{et ce pour évaluer la capacité des processus mis en
...
entreprise {\color{red}{sous forme d'abstraction}}. Une approche par points de vue guide la
...
d'entreprise telle qu'elle est définie par les parties prenantes, {\color{red}{elle}} est
d'autant plus facile {\color{red}{à appréhender à comprendre}}. Ces derniers peuvent aussi
...
d'abstraire les détails techniques et les nombreuses interconnexions {\color{red}{entre quoi et quoi?}} tout en
...
processus métier. {\color{red}{Dans ce cas}}, le calcul d'une valeur ne se fait pas au niveau
de la tache métier mais du module applicatif qui l'implémente. Le processus
métier est modélisé sous forme de diagrammes d'activité fUML. {\color{red}{Dans ce cas}} les
