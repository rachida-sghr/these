...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[trim= 0cm 3.5cm 0cm 0cm, width=1\textwidth]{images/demarche/approche_conceptuelle.pdf}
 \end{center}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[trim= 0cm 13cm 0cm 2cm, width=1\textwidth]{images/demarche/metamodele_framework.pdf}
 \end{center}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[trim= 0cm 18cm 0cm 0cm, width=1\textwidth]{images/demarche/metamodele_vue_integration.pdf}
 \end{center}
...
Avant de mener des analyses d'impact par exemple, il faut s'assurer que les modèles métier, fonctionnel et applicatifs sont bien alignés.
