...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[trim= 0cm 3.5cm 0cm 0cm, width=1\textwidth]{figures/images/demarche/approche_conceptuelle.pdf}
 \end{center}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[trim= 0cm 3cm 0cm 0cm, width=1\textwidth]{figures/images/demarche/vue_aspect.pdf}
 \end{center}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[trim= 3cm 3cm 0cm 0cm, width=1\textwidth]{figures/images/demarche/vue_integration.pdf}
 \end{center}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[trim= 0cm 13cm 0cm 2cm, width=1\textwidth]{figures/images/demarche/metamodele_framework.pdf}
 \end{center}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[trim= 0cm 18cm 0cm 0cm, width=1\textwidth]{figures/images/demarche/metamodele_vue_integration.pdf}
 \end{center}
...
\begin{figure}[!htbp]
 \begin{center}
  \includegraphics[width=0.7\textwidth]{figures/images/demarche/langages_vues.png}
 \end{center}
