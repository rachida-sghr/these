...
l'implémentation du système final.
	...
	Enfin, les représentations purement contemplative ne permettent pas d'exploiter les liens de traçabilité 
indispensables à la vérification de la cohérence de l'architecture sur 
toute la trajectoire de l'entreprise. La plupart des cadres d'EA ne représentent pas 
...
de les exploiter informatiquement \textit{a posteriori} pour valider la cohérence globale de l'architecture.   À titre d'exemple, ces liens sont utiles pour vérifier que les composants de la vue technique participent bien à l'exécution de la stratégie de l'entreprise. 
